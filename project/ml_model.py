...
def remove_correlated_features(X):
    ...
    final_columns_dropped.append(columns_dropped)
...
def get_columns_dropped():
    return final_columns_dropped
...
def init(data1):
    ...
    data = pd.read_csv("preprocessed_fault_data.csv")
    ...
    sns.histplot(target).set(title="Fault Count Graph")
